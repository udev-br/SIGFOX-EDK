...
/*
 * Example using the Ambient Light Sensor (SI1133)
...
void fnUSER_Loop( void )
{
   if ( !measured )
   {
      fnSI1133_Measure_Start_Callback_Mode();
      measured = true;
   }

//    fnSI1133_Measure_Start_Blocking_Mode( );
//    fnDEBUG_Uint16_Value( "LUX: ", fnSI1133_Get_Lux(), "; \r\n" );
//    fnDEBUG_Uint16_Value( "UV: ", fnSI1133_Get_Uvi(), "; \r\n" );
